...
class NeuralNetwork(object):
    ...
    def forward(self,inputs):
        ...
        return hidden_outputs,final_outputs# signals from final output layer
    
    def backprop(self,inputs,hidden_outputs,final_outputs,targets):
        ### Backward pass ###
        # TODO: Output error
    ...
    def train(self, inputs_list, targets_list):
        ...
        self.backprop(inputs,hidden_outputs,final_outputs,targets)
...
# 
# #### Your answer below
# My model predicts well in the beggining of December, but it doesn't work well in the end of the month.
# I guess that the reason is your consumption behaviors in the Christmass season are different from ones in other seasons.
